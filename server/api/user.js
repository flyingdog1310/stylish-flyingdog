...
import { createUser, createFbUser, checkUser, userSignIn, signInSuccess, getUserprofile } from "../database/user.js";
...
async function getFbInfo(clientToken) {
    return fetch(`https://graph.facebook.com/me?fields=id,name,email,picture&access_token=${clientToken}`, { method: "GET" }).then(
